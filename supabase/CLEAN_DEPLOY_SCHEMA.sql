-- ============================================================================
-- INNERCIRCLE - CLEAN DEPLOYMENT SCHEMA
-- ============================================================================
-- This script DROPS all existing tables and recreates everything from scratch
-- Use this for a clean deployment to avoid "relation already exists" errors
-- ============================================================================

-- ============================================================================
-- DROP EVERYTHING (in correct order to avoid dependency errors)
-- ============================================================================
...
DROP FUNCTION IF EXISTS notify_on_echo() CASCADE;
DROP FUNCTION IF EXISTS notify_on_signal() CASCADE;
DROP FUNCTION IF EXISTS increment_relay_count() CASCADE;
DROP FUNCTION IF EXISTS increment_echo_count() CASCADE;
DROP FUNCTION IF EXISTS decrement_signal_count() CASCADE;
DROP FUNCTION IF EXISTS increment_signal_count() CASCADE;
DROP FUNCTION IF EXISTS update_updated_at() CASCADE;
DROP FUNCTION IF EXISTS unlink_wallet_from_account(UUID, TEXT) CASCADE;
DROP FUNCTION IF EXISTS link_wallet_to_account(UUID, TEXT) CASCADE;
DROP FUNCTION IF EXISTS get_or_create_user_by_wallet(TEXT, TEXT) CASCADE;

-- Drop tables (in reverse dependency order)
DROP TABLE IF EXISTS notifications CASCADE;
DROP TABLE IF EXISTS transmissions CASCADE;
DROP TABLE IF EXISTS transmission_threads CASCADE;
DROP TABLE IF EXISTS orbits CASCADE;
DROP TABLE IF EXISTS relays CASCADE;
DROP TABLE IF EXISTS signals CASCADE;
DROP TABLE IF EXISTS echoes CASCADE;
DROP TABLE IF EXISTS post_gates CASCADE;
...
-- Multi-wallet: Get or create user by wallet (FIXED - no ambiguous columns)
...
-- Multi-wallet: Link additional wallet to account
...
-- Multi-wallet: Unlink wallet from account
...
-- ✅ All functions created (with multi-wallet support)
-- ✅ All triggers created
--
-- Next steps:
-- 1. Update your .env file with new Supabase credentials
-- 2. Test wallet connection
-- 3. Verify multi-wallet system works
--
-- ============================================================================
